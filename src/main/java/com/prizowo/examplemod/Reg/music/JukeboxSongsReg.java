...
public class JukeboxSongsReg {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> ZOMBIE_SOUND = SOUND_EVENTS.register("music_disc.zombie_sound",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Examplemod.MODID, "music_disc.zombie_sound")));
}
