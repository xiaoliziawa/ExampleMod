...
public class JukeboxSongsReg {
    ...
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister.create(Registries.SOUND_EVENT, Examplemod.MOD_ID);
    public static final DeferredRegister<JukeboxSong> JUKEBOX_SONGS = DeferredRegister.create(Registries.JUKEBOX_SONG, Examplemod.MOD_ID);
    public static final DeferredHolder<SoundEvent, SoundEvent> CUSTOM_SONG_SOUND = SOUND_EVENTS.register("music_disc.custom_song",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Examplemod.MOD_ID, "music_disc.custom_song")));
