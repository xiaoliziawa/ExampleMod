...
public class MountMovementController {
    ...
    private static boolean canFly(Mob mount) {
        return mount instanceof net.minecraft.world.entity.FlyingMob || // 飞行怪物
               mount instanceof net.minecraft.world.entity.animal.FlyingAnimal || // 飞行动物
               mount instanceof net.minecraft.world.entity.boss.enderdragon.EnderDragon || // 末影龙
               mount instanceof net.minecraft.world.entity.monster.Ghast || // 恶魂
               mount instanceof net.minecraft.world.entity.monster.Blaze || // 烈焰人
               mount instanceof net.minecraft.world.entity.boss.wither.WitherBoss; // 凋零
    }
} 